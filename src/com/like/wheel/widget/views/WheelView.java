...
package com.like.wheel.widget.views;
...
import com.like.wheel.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0xe0ffffff, 0x30ffffff };
	...
	private void drawBorder(Canvas canvas) {
		...
		int topCenter = center;
		int bottomCenter = center;
		Paint paint = new Paint();
		paint.setColor(getResources().getColor(R.color.province_line_border));
		paint.setStrokeWidth((float) 1);
		for(int i=0; i<3; i++) {
			topCenter = topCenter - 2 * offset;
			canvas.drawLine(0, topCenter - offset, getWidth(), topCenter - offset, paint);
		}
		for(int i=0; i<3; i++) {
			bottomCenter = bottomCenter + 2 * offset;
			canvas.drawLine(0, bottomCenter + offset, getWidth(), bottomCenter + offset, paint);
		}
	}
...
//		centerDrawable.draw(canvas);
	...
	public void setDrawShadow(boolean isDraw) {
		this.needShadow = isDraw;
